      ...
      <div className="fixed min-h-screen min-w-full">
        <main className={"min-h-screen flex flex-col justify-center text-center z-20"}>
          ...
          <div className="my-10 flex flex-row justify-center">
            <a className="bg-yellow-300 hover:bg-yellow-500 rounded-md text-black font-bold m-2 p-2 text-2xl w-1/6" href="https://forms.gle/96oK5mUZrmpTuT9W6">Sign Up</a>
            <a className="bg-yellow-300 hover:bg-yellow-500 rounded-md text-black font-bold m-2 p-2 text-2xl w-1/6" href="https://discord.gg/MVnV2qb">Join the Discord</a>
          </div>
        </main>
      </div>
    </div>
