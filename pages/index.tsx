      ...
      <div className="fixed min-h-screen min-w-full">
        <main className={"min-h-screen flex flex-col justify-center text-center z-20"}>
          ...
          <div className="flex flex-row justify-center">
            <Link href="/schedule"><div className="cursor-pointer transition-colors bg-yellow-300 hover:bg-yellow-500 rounded-md text-black font-bold m-2 p-2 text-2xl w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6">Schedule</div></Link>
            <Link href="/standings"><div className="cursor-pointer transition-colors bg-yellow-300 hover:bg-yellow-500 rounded-md text-black font-bold m-2 p-2 text-2xl w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6">Standings</div></Link>
          </div>
          <div className="flex flex-row justify-center">
            <a className="transition-colors bg-yellow-300 hover:bg-yellow-500 rounded-md text-black font-bold m-2 p-2 text-2xl w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6" href="https://discord.gg/MVnV2qb">Join the Discord</a>
          </div>
        </main>
      </div>
    </div>
